...
pd_data_humidity <- calculate_partial_dependence(rf_fit, trainData, "specific_humidity")
...
pd_data_tdtr <- calculate_partial_dependence(rf_fit, trainData, "tdtr_k")
...
pd_data_precip <- calculate_partial_dependence(rf_fit, trainData, "precipitation_amt")
